...
class RectCrSectSingle():
    ...
    @staticmethod
    def load_concrete(file_path='civil_calc/deep_backend/concrete_ec.csv'): #  'C:\\Python\\git_projects\\civil_calc\\deep_backend\\concrete_ec.csv'
    ...
    def _get_fcd_eta(self):
        ...
        conc_data = RectCrSectSingle.load_concrete(file_path='civil_calc/deep_backend/concrete_ec.csv')  # C:\Python\git_projects\Django_civil\civil_calc\deep_backend
